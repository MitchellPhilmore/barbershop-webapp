...
export const Services = () => {
  return (
    <div className="flex flex-col self-stretch py-20 bg-white">
      <div className="flex flex-col items-center self-center px-6 mt-40 w-full max-w-[1340px] max-md:px-5 max-md:mt-10 max-md:max-w-full">
        ...
        <div className="flex gap-0 self-stretch pl-20 mt-10 max-md:flex-wrap max-md:pl-5 max-md:mt-10 max-md:max-w-full">
          ...
          <img
            loading="lazy"
            src="https://cdn.builder.io/api/v1/image/assets/TEMP/46efb2d9eaafd650f3fe092fa901f83f63953d3e20f59047436762323033c2f7?"
            className="shrink-0 self-start max-w-full aspect-[0.53] w-[135px]"
          />
        </div>
        <div className="flex justify-center items-center self-stretch px-16 mt-16 text-lg font-black leading-5 text-center uppercase text-neutral-900 max-md:px-5 max-md:mt-10 max-md:max-w-full">
          <div className="flex gap-5 justify-between max-md:flex-wrap">
            <Link
              href={"/contact"}
              className=" cursor-pointer hover:bg-orange-300 justify-center px-6 py-8 bg-orange-200 max-md:px-5"
            >
              Book an appointment
            </Link>
            <Link
              href={"/services"}
              className=" hover:bg-black hover:text-white justify-center px-7 py-8 border border-solid border-neutral-900 max-md:px-5"
            >
              Browse all services
            </Link>
          </div>
      ...
      <img loading="lazy" srcSet="..." className="w-full max-md:max-w-full" />
    </div>
  );
};
